...
public class GameHandler : MonoBehaviour {
    ...
    string[] randomGuessIntro = new string[6] { "I like to call this phase 'WHAT IS THAT?'", "'Throwing Up Spaghetti?' 'Sandwich With Eyes?'", "Even if you know you're wrong, take a guess.", "Don't feel bad if you know your guess is wrong.", "If your guess is right, I'll give you a cookie.", "If you don't know what it is, describe the drawing."};
    ...
    string[] randomPostGameIntro = new string[6] { "Let's see how your drawings evolved!", "Get ready to be blown away by the amazing art.", "Time for everyone to judge you and your drawings.", "Let's have a look at the amazing art you made!", "Let's see how to bad your guesses were!", "Time for everyone to judge you for your awful drawing abilities! Hooray!"};
