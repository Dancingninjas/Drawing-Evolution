...
public class GameHandler : MonoBehaviour {
    ...
    string[] randomDrawIntro = new string[4] { "Time to draw something amazing, or maybe awful.", "Don't know how to draw something? Too bad!", "Use a variety of colors to bring the prompt to life.", "Time to scribble something down and call it art."};
