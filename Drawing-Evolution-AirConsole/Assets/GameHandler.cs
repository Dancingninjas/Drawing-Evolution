...
public class GameHandler : MonoBehaviour {
    ...
    public Image IntroductionImage2;
    public Image IntroductionImage3;
    ...
    string[][] TextArray =
    {
        ...
        new string[] /*1 DUTCH*/{ "Nederlands", "Welkom bij Drawing Evolution.", "De spelregels zijn heel simpel.", "Je krijgt een woord of zin om te tekenen.", "Een speler moet raden welk woord of zin je hebt getekend.", "Daarna moet een andere speler die gok moeten tekenen.","Hoe meer spelers je hebt, hoe meer ronden je kunt spelen.", "Aan het eind zullen we kijken hoe de zinnen zijn veranderd."/*TitleScreen 8 ---> */, "Welkom bij", "Taal:", "Spelmodus:", "            Willekeurige Opdracht", "            Schrijf Je Eigen Opdracht", "Toegestane Tekentijd:", "           TIME Minuten", "           1 Minuut", "Aantal Rondes:", "Automatisch", "Bekijk de Introductie:", "Wachten op spelers...", "Opmerking: Dit spel is het leukst om met 4+ spelers te spelen.", "Schrijf een Woord of Zin", "Iemand Anders Zal Het Moeten Tekenen", "Tekenfase", "Teken het Woord op Jouw Apparaat", "Gokfase", "Beschrijf de Tekening op Jouw Apparaat", "Spelers Klaar", "Origineel Zin:", "Laatste Zin:", "tekende:", "raadde:", "schreef:", "Tekenfase", "Gokfase", "Schrijffase", "Tijd om te beoordelen!"},
        new string[] /*2 FRENCH*/{ "      Français", "Bienvenue à Drawing Evolution", "Les règles du jeu sont simples.", "On vous donne un mot ou une phrase à dessiner.", "Un joueur devra deviner quel mot ou quelle phrase vous avez dessiné...", "Puis, un autre joueur devra dessiner cette devinette.", "Plus vous avez de joueurs, plus vous pouvez jouer de tours.", "A la fin, nous observerons comment les phrases ont évolué."/*TitleScreen 8 ---> */, "Bienvenue dans", "Langue:", "Mode:", "Invitation Aléatoire", "Écrivez Votre Propre Invite", "Longueur du Dessin:", "        TIME Minutes", "        1 Minute", "Nombre de Phases: ", "Automatique", "Regarder l'Introduction:", "En attente de joueurs...", "Remarque: ce jeu est plus amusant lorsqu'il est joué à 4 joueurs ou plus", "Écrivez un Mot ou une Phrase", "Quelqu'un d'autre devra l'esquisser", "Phase de Dessin", "Dessinez le Mot sur Votre Appareil", "Phase de Devinette", "Décrire l'image sur votre appareil", "Joueurs Prêts", "Phrase Originale:", "Phrase Finale:", "a dessiné:", "a deviné:", "a écrit:", "Phase de Dessin", "Phase de Devinette", "Phase D'Ecriture", "Temps de laisser une Revue!"},
        new string[] /*3 GERMAN*/{ "        Deutsch", "Willkommen bei Drawing Evolution.", "Die Regeln dieses Spiels sind einfach.", "Sie erhalten ein Wort oder einen Satz zum Zeichnen.", "Ein Spieler muss raten, welches Wort oder welche Phrase Sie gezeichnet haben.", "Dann muss ein anderer Spieler diese Vermutung ziehen.", "Je mehr Spieler du hast, desto mehr Runden kannst du spielen.", "Am Ende schauen wir uns an, wie sich die Sätze entwickelt haben."/*TitleScreen 8 ---> */, "Willkommen bei", "Sprache:", "Modus:", "  Zufälliger Vorschlag", "  Schreibe deinen eigenen Vorschlag", "Zeit Zum Zeichnen:", "     TIME Minuten", "     1 Minute", "Anzahl der Phasen:", "Automatisch", "Einführung Anschauen:", "Warten auf Spieler...", "Hinweis: Dieses Spiel macht am meisten Spaß, wenn es mit 4 oder mehr Spielern gespielt wird.", "Jemand anders muss es zeichnen", "Jemand anderes muss es zeichnen", "Zeichenmodus", "Zeichne das Wort auf deinem Gerät", "Ratephase", "Beschreibe das Bild auf deinem Gerät", "Bereite Spieler", "Ursprünglicher Begriff:", "Letzter Begriff:", "zeichnete:", "schrieb:", "schrieb:", "Zeichenphase", "Ratephase", "Schreibphase", "Zeit für eine Bewertung!"},
        new string[] /*4 ITALIAN*/{ "     Italiano", "Benvenuto in Drawing Evolution.", "Le regole di questo gioco sono semplici.", "Ti viene data una parola o una frase da disegnare.", "Un giocatore dovrà indovinare la parola o frase che hai disegnato.", "Dopodiché un altro giocatore dovrà disegnare l'ipotesi suggerita dall'altro giocatore.", "Più giocatori sono presenti, più si possono giocare round.", "Alla fine, si osserverà l'evoluzione della frase/parola."/*TitleScreen 8 ---> */, "Benvenuto in", "Lingua:", "Modalità:", "       Suggerimento Casuale", "       Scrivi Il Tuo Suggerimento", "Tempo Di Disegnare:", "        TIME Minuti", "        1 Minuto", "Numero di Fasi:" , "Automatico", "Guarda L'Introduzione:", "Aspettando i giocatori...", "Nota: Questo gioco è più divertente se giocato con più di 4 giocatori", "Scrivi Una Parola O Una Frase", "Qualcun Altro Dovrà Disegnarla", "Fase di Disegno", "Disegna la parola sul tuo dispositivo", "Fase di Indovinare", "Descrivi l'immagine sul tuo dispositivo", "Giocatori Pronti", "Frase Originale:", "Frase Finale:", "ha disegnato:", "ha scritto:", "ha scritto:", "Fase di Disegno", "Fase di Indovinare", "Fase di Scrittura", "È ora di rivedere!"},
    ...
    List<string> randomList; //contains potential words and can be added/removed. if size is 0, it copies randomlistmisc and randomlisthalloween
    List<List<string>> randomListTheme;
    //List<string> randomListHalloween;
    List<int> EnabledThemesList;
    ...
    string[][][] randomListJaggedArray2 =
    { //randomListJaggedArray2[themenum][langnum][]
        ...
        //{
        //    new string[] /*0 ENGLISH*/{"Eating Your Children's Candy", "Pretending to be a Halloween Decoration", "Taking Two Candies From the Bowl", "Trunk or Treat", "Changing Costumes to Get More Candy", "Jason vs Freddy", "Group Costume", "Turning into a Werewolf", "Eating Too Much Candy", "Toilet-Papering Houses", "Getting Your Head Stuck in a Pumpkin", "Zombie Dance Party", "Haunted House", "Costume Party", "Witch Brewing Potions", "Shopping for Halloween Costumes", "Getting Scared by Anamatronics", "Watching Scary Movies in the Dark", "Witch Melting", "Fog Machine", "Vampire Sleeping in a Coffin", "Catching a Ghost", "Hiding from Zombies", "Using a Sheet to Pretend to be a Ghost", "Sugar High", "Picking out the Perfect Pumpkin", "Graveyard Resurrection", "Dog Costume", "Friendly Ghost", "Waking up from a Nightmare", "Skeleton Taxi Driver", "Vampire Slayer", "Smart Zombie", "Vampire at the Dentist", "Headless Horseman", "Pumpkin King", "Nurse Costume", "Vampire Sucking Blood", "Sweating in Your Halloween Costume", "Scary Stories", "Haunted Hay Ride", "Abandoned Amusement Park", "Buying Candy on Sale After Halloween", "Low-Effort Costume", "Using a Fake Kid in a Stroller to Get Candy", "Corn Maze", "Ringing the Doorbell", "Wolves howling", "Mummy", "Vampire Cat", "Flashlight Going Out", "Spotting a Bat", "Weird Kid Who Likes Candy Corn", "Making Your Own Halloween Costume", "Bobbing for Apples", "Goosebumps"},
        //    new string[] /*1 DUTCH*/{"Snoep van je kinderen opeten","Doen alsof je een Halloween-decoratie bent","Twee snoepjes uit de kom halen","Wat lekker of de roe","Van kostuums veranderen om meer snoep te krijgen","Jason vs Freddy","Groepskostuum","In een weerwolf veranderen","Te veel snoep eten","Huisjes van karton","Met je hoofd vast komen te zitten in een pompoen","Zombiedans feestje","Spookhuis","Kostuumfeestje","Heks brouwt drankjes","Winkelen voor Halloween kostuums","Schrikken van bewegende poppen","In het donker naar enge films kijken","De heks smelt","Mistmachine","Vampier die in een kist slaapt","Een spook vangen","Verstoppen voor zombies","Een laken gebruiken om zich voor te doen als een spook","Suikerrush","De perfecte pompoen uitzoeken","Kerkhof verrijzenis","Hondenkostuum","Vriendelijke geest","Wakker worden uit een nachtmerrie","Skelet taxichauffeur","Vampierdoder","Slimme zombie","Vampier bij de tandarts","Hoofdloze ruiter","Pompoen koning","Zusterkostuum","Vampier die bloed zuigt","Zweten in je Halloweenkostuum","Enge verhalen","Spookrit","Verlaten pretpark","Snoep in de aanbieding na Halloween","Simpel kostuum","Een nepkind in een kinderwagen gebruiken om snoep te krijgen","Maïsdoolhof","Aanbellen","Wolven huilen","Mama","Vampierkat","Zaklamp gaat uit","Een vleermuis spotten","Vreemde gast die van snoep houdt","Je eigen Halloween kostuum maken","Appels uit water vissen","Kippenvel"},
        //    new string[] /*2 FRENCH*/{"Manger les bonbons de vos enfants","Faire semblant d'être une décoration d'Halloween","Prendre deux bonbons du bol","Coffre ou friandise","Changer de costume pour avoir plus de bonbons","Jason vs Freddy","Costume de groupe","Se transformer en loup-garou","Manger trop de bonbons","Tapisser les maisons de papier toilette","Se coincer la tête dans une citrouille","Soirée dansante zombie","Maison hantée","Fête costumée","Potions de sorcière","Magasiner pour les costumes d'Halloween","Se faire peur par anamatronics","Regarder des films effrayants dans le noir","Fondre la sorcière","Machine à brouillard","Vampire dormant dans un cercueil","Attraper un fantôme","Se cacher des zombies","Utiliser un drap pour se faire passer pour un fantôme","Buzz de sucre","Choisir la citrouille parfaite","La résurrection du cimetière","Costume de chien","Fantôme amical","Se réveiller d'un cauchemar","Chauffeur de taxi squelette","Tueur de vampire","Zombie intelligent","Vampire chez le dentiste","Cavalier sans tête","Roi citrouille","Costume d'infirmière","Vampire suçant le sang","Transpirer dans votre costume d'Halloween","Histoires effrayantes","Tour de foin hanté","Parc d’amusement abandonné","Achat de bonbons en vente après Halloween","Costume sans effort","Utiliser un faux enfant dans une poussette pour obtenir des bonbons","Labyrinthe de maïs","Sonner à la porte","Des loups hurlant","Momie","Chat vampire","Lampe de poche s’éteignant","Repérer une chauve-souris","Gamin bizarre qui aime les bonbons au maïs","Faire votre propre costume d'Halloween","Chaire de poule",},
        //    new string[] /*3 GERMAN*/{"Die Süßigkeiten deiner Kinder zu essen","Vorgeben, eine Halloween-Dekoration zu sein","Zwei Bonbons aus der Schüssel nehmen","Kofferraum oder Leckerbissen","Kostüme wechseln, um mehr Süßigkeiten zu bekommen","Jason vs. Freddy","Gruppenkostüm","Umwandlung in einen Werwolf","Zu viel Süßigkeiten essen","Toilettendeckelhäuser","Den Kopf in einen Kürbis stecken zu lassen","Zombie-Tanzparty","Spukhaus","Kostümfest","Hexenbrühtränke","Halloween-Kostüme einkaufen","Angst vor Anamatronik bekommen","Gruselige Filme im Dunkeln ansehen","Hexenschmelzen","Nebelmaschine","Vampir schläft in einem Sarg","Einen Geist fangen","Verstecken vor Zombies","Ein Blatt benutzen, um vorzugeben, ein Geist zu sein","Zucker-High","Aussuchen des perfekten Kürbisses","Auferstehung auf dem Friedhof","Hundekostüm","Freundlicher Geist","Aufwachen aus einem Alptraum heraus","Skelett-Taxifahrer","Vampir-Töter","Schlauer Zombie","Vampir beim Zahnarzt","Kopfloser Reiter","Kürbiskönig","Krankenschwester Kostüm","Vampir, der Blut saugt","Schwitzen in deinem Halloween-Kostüm","Gruselige Geschichten","Geisterhafter Heu-Ritt","Verlassener Vergnügungspark","Kauf von Süßigkeiten im Angebot nach Halloween","Aufwandsarmes Kostüm","Maislabyrinth","Klingeln an der Haustür","Wölfe heulen","Mami","Vampir-Katze","Die Taschenlampe erlischt","Ich sehe eine Fledermaus","Seltsames Kind, das Zuckermais mag","Erstelle dein eigenes Halloween-Kostüm","Wippende Äpfel","Gänsehaut"},
        //    new string[] /*4 ITALIAN*/{"Mangia le tue caramelle per bambini","Fingi di essere una decorazione di Halloween","Prendi due caramelle dalla ciotola","Dolcetto o scherzetto","Cambia costume per ottenere più caramelle","Jason vs Freddy","Costume di gruppo","Trasformati in un lupo mannaro","Mangiare troppe caramelle","Coprire le case di carta igienica","Testa incastrata in una zucca","Festa di ballo degli zombie","Casa infestata","Festa in maschera","Pozioni di streghe","Shopping per i costumi di Halloween","Farsi spaventare dagli animatronics","Guardare film del orrore al buio","Strega che si scioglie","Macchina per la nebbia","Vampiro che dorme in una bara","Catturare un fantasma","Nascondersi dagli zombie","Eccitamento da zuccheri","Scegli la zucca perfetta","Resurrezione al cimitero","Costume da cane","Fantasma simpatico","Svegliarsi da un incubo","Tassista scheletro","Ammazzavampiri","Zombie intelligente","Vampiro dal dentista","Fantino senza testa","Re delle zucche","Costume da infermiera","Vampiro che succhia sangue","Sudare nel tuo costume di Halloween","Storie spaventose","Giro nel campo infestato","Parco giochi abbandonato","Acquistare caramelle in sconto dopo Halloween","Costume a basso sforzo","Labirinto nel campo di grano","Suona il campanello","Lupi che ululano","Mummia","Gatto vampiro","Torcia che si spegne","Individuare un pipistrello","Ragazzo strano a cui piacciono i pop corn dolci","Crea il tuo costume di Halloween","Gioco del bobbing con le mele","Pelle d'oca"},
        //    new string[] /*5 PORTUGUESE*/{"Comer os doces dos seus filhos","Fingir ser uma decoração de Halloween","Tirar dois doces da taça","Doçura ou bagageira","Mudar de fantasia para receber mais doces","Jason vs Freddy","Fantasia de grupo","Transformar-se num lobisomem","Comer demasiados doces","Atirar papel higiénico às casas","Ficar com a cabeça presa numa abóbora","Festa de danças zombie","Casa assombrada","Festa de trajes de fantasias","Poções de bruxas","Comprar fantasias de Halloween","Assustar-se com animatrónica","Ver filmes de terror às escuras","Bruxas a derreter","Máquina de fazer nevoeiro","Vampiro a dormir num caixão","Apanhar um fantasma","Esconder-se dos zombies","Usar um lençol para fingir ser um fantasma","Overdose de açúcar","Escolher a abóbora perfeita","Ressurreição do cemitério","Fantasia de cão","Fantasma amigável","Acordar de um pesadelo","Taxista esqueleto","Assassino de vampiros","Zombie inteligente","Vampiro no dentista","Cavaleiro sem cabeça","Rei abóbora","Fantasia de enfermeira","Vampiro a sugar sangue","Transpirar a fantasia de Halloween","Histórias de terror","Passeio assombrado no feno","Parque de diversões abandonado","Comprar doces em promoção depois do Halloween","Fantasia pouco pensada","Labirinto de milho","Tocar à campainham","Lobos a uivar","Múmia","Gato vampiro","Lanterna a apagar","Encontrar um morcego","Rapaz estranho que gosta de milho doce","Fazer seu próprio traje de Halloween","Apanhar maçãs com a boca","Arrepios"},
        //    new string[] /*6 SPANISH*/{"Comiendo los dulces de tus hijos","Pretendiendo ser una decoración de Halloween","Tomando dos dulces del tazón","Truco o trato","Cambiando de disfraces para obtener más dulces","Jason vs Freddy","Cosplay Grupal","Convirtiéndose en un hombre lobo","Comiendo demasiados dulces","Llenando casas de papel higiénico","Atascando tu cabeza en una calabaza","Fiesta de baile zombi","Casa embrujada","Fiesta de disfraces","Bruja elaborando pociones","Comprar disfraces de Halloween","Asustarse por muñecos animatrónicos","Viendo películas de miedo en la oscuridad","Bruja derritiéndose","Máquina de humo","Vampiro durmiendo en un ataúd","Atrapando un fantasma","Escondiéndose de los zombis","Usando una sábana para pretender ser un fantasma","Con demasiada azúcar","Escogiendo la calabaza perfecta","Resurrección en el cementerio","Disfraz de perro","Fantasma amigable","Despertando de una pesadilla","Taxista esqueleto","Asesino de vampiros","Zombi inteligente","Vampiro en el dentista","Jinete sin cabeza","Rey calabaza","Disfraz de enfermera","Vampiro chupando sangre","Sudando en tu disfraz de Halloween","Historias de miedo","Paseo embrujado","Parque de atracciones abandonado","Comprar dulces en descuento luego de Halloween","Traje de bajo presupuesto","Laberinto de maíz","Tocando el timbre","Lobos aullando","Momia","Gato vampiro","Linterna apagándose","Ver un murciélago","Haciendo tu propio disfraz de Halloween","Morder una manzana","Piel de Gallina"},
        //}
        new string[][] //Christmas
        {
            new string[] /*0 ENGLISH*/{"Picking out a Christmas Tree","Christmas Music on the Radio","Grandma Got Run Over by a Reindeer","Santa Falling off the Roof","Setting a Trap for Santa","Santa at the Mall","Polar Express","Mommy Kissing Santa Claus","Playing Reindeer Games","Facing the Ugly Part of the Tree Toward the Wall","Dropping an Ornament on the Floor","Elf on the Shelf","Ugly Christmas Sweater Contest","Chestnuts Roasting on an Open Fire","Ebenezer Scrooge","Buddy the Elf","Closing the Door on Christmas Carolers","Making Christmas Cards","Christmas Family Photo","Shaking a Snow Globe","Getting a Gift You Don't Like","Walking Under the Mistletoe","Hanging the Stockings","Family Gathering","Christmas Tree Shop","Secret Santa","Making a Gingerbread House","Figgy Pudding","Ghost of Christmas Past","Reindeer Teasing Rudolph","Writing a Letter for Santa","Popcorn String","Santa's Workshop","Tiny Tim","Wrapping a Gift","The Grinch's Tiny Heart","Frosty the Snowman Coming to Life","Decorating the House","Relaxing by the Fire","Holiday Baking","Santa Stuck in the Chimney","Prepping Santa's Sleigh","Christmas Parade","Hallmark Christmas Movie","The Smell of Christmas","Reindeer Gone Missing","Reindeer Animatronic","Krampus","Snow Day","Waiting in the Cold for the School Bus","Dog Playing in the Snow","Don't Eat the Yellow Snow","Jumping in a Pile of Snow","Sledding down a Hill","Making Snow Angels","Slipping on Ice", "Find the Pickle Game"},
            new string[] /*1 DUTCH*/{"Een kerstboom uitzoeken","Kerstmuziek op de radio","Oma werd overreden door een rendier","Kerstman die van het dak afvalt","Een val voor de kerstman zetten","De kerstman in het winkelcentrum","Polar Express","Mama die de kerstman kust","Rendierspelletjes spelen","Tegenover het lelijke deel van de boom, richting de muur","Een ornament op de vloer laten vallen","Lelijke kersttruienwedstrijd","Kastanjes roosteren op een open vuur","Ebenezer Scrooge","De deur dichtdoen voor zangers van kerstliedjes","Kerstkaarten maken","Kerstfamiliefoto","Een sneeuwbol schudden","Een cadeau krijgen dat je niet leuk vindt","Onder de maretak doorlopen","De kousen ophangen","Familiebijeenkomst","Kerstboom winkel","Geheime Kerstman","Een peperkoekhuis maken","Kerstpudding","Spook van het kerstverleden","Rendier plaagt Rudolph","Brief schrijven voor de kerstman","Popcornketting","Werkplaats van de kerstman","Een cadeau inpakken","Het kleine hartje van de Grinch","Het huis versieren","Ontspannen bij het haardvuur","Bakken in de vakantie","Kerstman vast in de schoorsteen","Slee van de kerstman voorbereiden","Kerstoptocht","Kerstfilm","De geur van Kerstmis","Rendieren vermist","Rendier Animatronic","Krampus","Sneeuwdag","In de kou wachten op de schoolbus","Hond die in de sneeuw speelt","Eet de gele sneeuw niet op","In een berg sneeuw springen","Van een heuvel sleeën","Sneeuwengels maken","Op ijs uitglijden"},
            new string[] /*2 FRENCH*/{"Choisir Un Arbre De Noël","Musique De Noël À La Radio","Grand-Mère Se Faire Écraser Par Un Renne","Père Noël Tombant Du Toit","Tendre Un Piège Pour Le Père Noël","Père Noël Au Centre Commercial","Express Polaire","Maman Embrassant Le Père Noël","Jouer À Des Jeux De Renne","La Partie Laide De L'arbre Face Au Mur","Échapper Un Ornement Sur Le Sol","Lutin Sur L'étagère","Concours De Chandail De Noël Moche","Les Châtaignes Grillent Sur Un Feu Ouvert","Ebenezer Scrooge","Buddy Le Lutin","Fermer La Porte Aux Chanteurs De Noël","Faire Des Cartes De Noël","Photo De Famille De Noël","Secouant Un Globe De Neige","Obtenir Un Cadeau Que Vous N'aimez Pas","Marcher Sous Le Gui","Suspendre Les Bas","Réunion De Famille","Magasin D'arbres De Noël","Père Noël Secret","Faire Une Maison En Pain D'épice","Pudding Aux Figues","Fantôme De Noël Passé","Les Rennes Taquinant Rudolph","Écrire Une Lettre Pour Le Père Noël","Ficelle De Popcorn","Atelier Du Père Noël","Tiny Tim","Emballer Un Cadeau","Le Petit Coeur Du Grinch","Frosty Le Bonhomme De Neige Revenant À La Vie","Décorer La Maison","Détente Par Le Feu","Cuisson De Vacances","Père Noël Coincé Dans La Cheminée","Préparer Le Traîneau Du Père Noël","Parade De Noël","Film De Noël","La Senteur De Noël","Rennes Manquantes","Rennes Animatronique","Krampus","Jour De Neige","Attendre L’autobus Scolaire Dans Le Froid","Chien Jouant Dans La Neige","Ne Mange Pas La Neige Jaune","Saut Dans Un Tas De Neige","Descendre Une Colline En Traîneau","Faire Des Anges De Neige","Glisser Sur La Glace"},
            new string[] /*3 GERMAN*/{"Einen Weihnachtsbaum aussuchen","Weihnachtsmusik im Radio","Großmutter wurde von einem Rentier überfahren","Der Weihnachtsmann fällt vom Dach","Dem Weihnachtsmann eine Falle stellen","Der Weihnachtsmann im Einkaufszentrum","Mami küsst den Weihnachtsmann","Rentierspiele spielen","Gegenüber dem hässlichen Teil des Baumes zur Wand","Ein Ornament auf den Boden fallen lassen","Hässlicher Weihnachtspullover-Wettbewerb","Kastanienröstung auf offenem Feuer","Ebenezer Scrooge","Buddy, der Elf","Die Tür der Weihnachtssänger schließen","Erstellen von Weihnachtskarten","Weihnachts-Familienfoto","Ein Geschenk bekommen, das dir nicht gefällt","Spaziergang unter der Mistel","Aufhängen der Strümpfe","Familientreffen","Weihnachtsbaum-Shop","Wichteln Sie den Weihnachtsmann","Ich mache ein Lebkuchenhaus","Geist der vergangenen Weihnachten","Rentiere necken Rudolph","Einen Brief für den Weihnachtsmann schreiben","Weihnachtsmann-Werkstatt","Der kleine Tim","Ein Geschenk einpacken","Das winzige Herz des Grinchs","Frosty der Schneemann kommt zum Leben","Dekorieren des Hauses","Entspannen am Feuer","Weihnachtsbäckerei","Santa Stuck im Schornstein","Ich bereite den Schlitten des Weihnachtsmanns vor","Weihnachtsparade","Weihnachtsfilm","Der Duft von Weihnachten","Rentiere fehlen","Rentier Animatronic","Krampus","Schneetag","Warten in der Kälte auf den Schulbus","Hund spielt im Schnee","Iss nicht den gelben Schnee","Springen in einem Schneehaufen","Schlittenfahrt auf einem Hügel","Schnee-Engel machen","Rutschen auf dem Eis"},
            new string[] /*4 ITALIAN*/{"Scegliere un albero di Natale","Musica di Natale alla radio","La nonna è stata investita da una renna","Babbo Natale che cade dal tetto","Piazzare una trappola per Babbo Natale","Babbo Natale al centro commerciale","Polar Express","La mamma dà un bacio a Babbo Natale","Mettere la parte brutta dell'albero contro il muro","Far cadere una decorazione sul pavimento","Gara di maglioni natalizi brutti","Castagne arrostite su una fiamma viva","Ebenezer Scrooge","Buddy l'elfo","Chiudere la porta ai canti natalizi","Fare bigliettini natalizi","Foto di famiglia a Natale","Agitare un globo di neve","Ottenere un regalo che non ti piace","Camminare sotto il vischio","Appendere le calze","Riunione di famiglia","Negozio di alberi di Natale","Secret Santa","Fare una casetta di pan di zenzero","Torta di fichi","Fantasma del Natale passato","Rudolph che prende in giro una renna","Scrivere una lettera per Babbo Natale","Officina di Babbo Natale","Piccolo Tim","Confezione regalo","Il piccolo cuore del Grinch","Frosty, il pupazzo di neve che prende vita","Decorare la casa","Rilassarsi accanto al fuoco","Dolcetti natalizi","Babbo Natale incastrato nel camino","Preparare la slitta di Babbo Natale","Parata natalizia","Film di Natale","L'odore del Natale","Renne scomparse","Animatronic di renne","Krampus","Giorno di neve","Aspettando lo scuolabus al freddo","Cane che gioca nella neve","Non mangiare la neve gialla","Saltare in un mucchio di neve","Slittare giù per una collina","Fare gli angeli di neve","Scivolando sul ghiaccio"},
            new string[] /*5 PORTUGUESE*/{"Escolher uma árvore de Natal","Música de Natal na rádio","A avó foi atropelada por uma rena","Pai Natal a cair do telhado","Montar uma armadilha para o Pai Natal","Pai Natal no centro comercial","Expresso Polar","Mãe a beijar o Pai Natal","Jogar jogos de renas","Virar a parte feia da árvore de Natal para a parede","Deixar cair um enfeite ao chão","Elfo na prateleira","Concurso de camisola de Natal mais feia","Castanhas a assar em fogo aberto","Ebenezer Scrooge","Buddy, o Elfo","Bater com a porta na cara de cantores de Natal","Fazer cartões de Natal","Fotografia de família natalícia","Agitar um globo de neve","Receber um presente que não gostas","Passar por baixo do visco","Pendurar as meias","Reunião de família","Loja de árvores de Natal","Amigo Secreto","Fazer uma casa de gengibre","Pudim de figo","Fantasma do Natal Passado","Rena a meter-se com o Rodolfo","Escrever uma carta ao Pai Natal","Cordão de pipocas","Oficina do Pai Natal","Tiny Tim","Embrulhar um presente","O coração pequeno de Grinch","O boneco de neve a ganhar vida","Decorar a casa","Relaxar à lareira","Pratos de Natal","Pai Natal preso na chaminé","Preparar o trenó do Pai Natal","Parada de Natal","Filme de Natal","O cheiro do Natal","Rena perdida","Rena animatrónica","Krampus","Dia de neve","À espera do autocarro escolar ao frio","Cão a brincar na neve","Não comas a neve amarela","Mergulhar num monte de neve","Descer colina de trenó","Fazer anjos de neve","Escorregar no gelo"},
            new string[] /*6 SPANISH*/{"Escogiendo un Árbol de Navidad","Música Navideña en la Radio","La abuela fue atropellada por un reno","Santa Cayendo del Techo","Colocando una Trampa para Santa","Santa en el Centro Comercial","Expreso Polar","Mamá Besando a Santa Claus","Jugando Juegos de Renos","Colocando la parte Fea del Árbol Hacia el Muro","Dejando Caer un Adorno al Piso","Elfo en el Estante","Concurso de Suéteres Navideños Feos","Castañas Asadas en Fuego Abierto","Ebenezer Scrooge","Mi Compañero el Elfo","Cerrando la Puerta a los Villancicos Navideños","Creando Tarjetas de Navidad","Foto Familiar Navideña","Agitando un Globo de Nieve","Recibiendo un Regalo que no te Gusta","Caminando Bajo el Muérdago","Colgando las Medias","Reunión Familiar","Tienda de Árboles Navideños","Santa Secreto","Haciendo una Casa de Pan de Jengibre","Pudín de Figgy","Fantasmas de las Navidades Pasadas","Reno Burlándose de Rodolfo","Escribiendo una Carta para Santa","Cadena de Palomitas de Maíz","Taller de Papá Noel","Pequeño Tim","Envolviendo un Regalo","El Pequeño Corazón del Grinch","Frosty, el Muñeco de Nieve que Tomó Vida","Decorando la Casa","Relajándose Junto al Fuego","Horneado Vacacional","Santa Atrapado en la Chimenea","Preparando el Trineo de Papá Noel","Desfile Navideño","Película Navideña","El Olor de la Navidad","Reno Desaparecido","Reno Animatrónico","Krampus","Día Nevado","Esperando en el Frío el Autobús Escolar","Perro Jugando en la Nieve","No Comas la Nieve Amarilla","Saltando en un Montón de Nieve","Bajando en un Trineo","Haciendo Ángeles de Nieve","Resbalándose en el Hielo"},
        }
    };
    ...
    string[][] randomDrawIntroArray =
    {
        ...
        new string[] /*1 DUTCH*/{"Tijd om iets geweldigs te tekenen, of misschien iets heel lelijks.", "Weet je niet hoe je iets moet tekenen? Jammer dan!","Gebruik verschillende kleuren om het leven te brengen.", "Tijd om iets te schetsen en het kunst te noemen.", "Scherp die denkbeeldige potloden aan, en bereid je voor om te gaan tekenen!","Alles is mooi op zijn eigen manier, maar voel je vrij om te bewijzen dat ik het mis heb."},
        ...
        new string[] /*3 GERMAN*/{"Zeit, etwas Sagenhaftes oder vielleicht Schreckliches zu zeichnen.", "Du weißt nicht, wie man etwas zeichnet? Schade!", "Verwende eine Vielzahl von Farben, um den Vorschlag zum Leben zu erwecken.", "Zeit, etwas zu kritzeln und es Kunst zu nennen.", "Spitze diese imaginären Stifte an und mache dich zum Zeichnen bereit!", "Alles ist auf seine eigene Weise schön, aber du kannst mir gerne zeigen, dass ich falsch liege." },
    ...
    string[][] randomGuessIntroArray =
    {
        ...
        new string[] /*1 DUTCH*/{"Bereid je voor op totale verwarring", "'Spaghetti Kotsen?' 'Broodje Met Ogen?'", "Zelfs als je weet dat je het mis hebt, moet je raden.", "Voel je niet slecht als je weet dat je het fout hebt geraden.","Als je het goed hebt geraden, geef ik je een koekje.","Als je niet weet wat het is, kan je de tekening beschrijven."},
        ...
        new string[] /*3 GERMAN*/{"Sei bereit für völlige Verwirrung!", "Spaghetti in die Luft werfen? Sandwich mit Augen?", "Auch wenn du meinst, du liegst falsch, rate doch trotzdem.", "Kein Grund sich schlecht zu fühlen, auch wenn du weißt, dass dein Raten falsch ist.", "Wenn dein Raten richtig ist, gebe ich dir  einen Keks.", "Wenn du nicht weißt, was es ist, beschreibe die Zeichnung."},
    ...
    string[][] randomInitialPhraseIntroArray =
    {
        ...
        new string[] /*1 DUTCH*/{"Schrijf over een persoon, een inside joke, of wat dan ook!","Jij bepaalt wat anderen moeten tekenen!", "'Jan Morst Alweer Koffie op de Kopieermachine'", "Bedenk iets wat je wilt dat iemand anders tekent.","Je kunt alles schrijven wat je maar wilt, grappig of serieus."},
        ...
        new string[] /*3 GERMAN*/{ "Schreibe über eine Person, privaten Witz oder irgendetwas!", "Du entscheidest, was andere zeichnen müssen!", "Hans verschüttet wieder Kaffee auf dem Kopierer", "Denke an etwas, das jemand anders zeichnen soll.", "Du kannst alles schreiben, was du willst, lustig oder ernst."},
    ...
    string[][] randomPostGameIntroArray =
    {
        ...
        new string[] /*1 DUTCH*/{"Laten we eens kijken hoe je tekeningen zijn geëvolueerd!","Bereid je voor om te worden weggeblazen door de ongekende kunstzinnigheid.", "Tijd voor iedereen om jou en je tekeningen te beoordelen.", "Laten we eens kijken naar de geweldige kunst die je hebt gemaakt!","Laten we eens kijken hoe slecht jullie gokken waren!"},
        ...
        new string[] /*3 GERMAN*/{"Mal sehen, wie sich deine Zeichnungen entwickelt haben!", "Bereite dich darauf vor, von der sagenhaften Kunst umgehauen zu werden.", "Zeit für alle, dich und deine Zeichnungen zu bewerten.", "Werfen wir doch einen Blick auf die sagenhafte Kunst, die du gemacht hast!", "Mal sehen, wie schlecht dein Raten war!"},
    ...
    string[] randomListArrayDutch = new string[301] { "Presidentiële speech", "Thanksgiving Diner", "Verkeeswode", "Vuile Sokken", "Taco Tuesday", "Eerste keer op een fiets rijden", "Blinde man die voor het eerst kan zien", "Professionele Bowler", "Last Minute huiswerk Stress", "Skype Interview", "Sterrenkijken", "Midnight Snack", "Vergeten de broek aan te doen", "Iemand helpen de straat over te steken", "Klock knock Grap", "Een bordspel spelen", "Verstoppertje spelen", "Roddelen op school", "Nieuw iemand op school", "Een appel per dag houdt de dokter uit de buurt", "Huilen over gemorste melk", "Een geit melken", "Hooirit", "Vakantie", "Houthakker", "Tweeling", "Hondentraining", "Bankhanger", "Heldhaftige", "Hoolahoopen", "Dance Battle", "Neem je kind mee naar het werk dag", "Gazon maaien", "Zomer", "Superheld", "Zielig Liedje", "Hoefijzer werpen", "Ziek melden en Thuis blijven", "Waterballongevecht", "Huishoudklusjes doen", "Boodschappen doen", "Slaapfeestje", "Home Run", "Dansende Dwergen", "Karaoke", "De Bus missen", "Familiefeestje", "Nieuwsvoorlezer", "Spellingsbij", "Monster onder het bed", "Huiswerksmoesje", "Zakkenrollen", "Onderwijs", "Cartoons", "Dingen uitstellen", "Touwtrekken", "Frisbee Golf", "Stop er een sok in'.", "Autoreclame", "Je teen stoten", "Beste vriend", "Natuurliefhebber", "Kat die een bad neemt", "De Cake eten", "Iets uitvinden", "Een wandeling maken", "Een broodje maken", "Je sleutels verliezen", "Rivier van Tranen", "Nachtmerrie", "Smaaktest", "Blind Date", "All-You-Can-Eat Buffet", "1 Ster Restaurant", "Snoep van een baby afpakken", "Gebroken paraplu", "Populair Kind", "Duiken in het zwembad", "Schaatsen", "Tikkertje spelen", "Volleybal", "Voorstel fout gegaan", "Klasse Clown", "Coole Gasten gaan niet naar Exposities", "De Vuilnisbak schoonmaken", "Ga van mijn gazon af!", "Pizzabezorging", "Presentatie in de klas", "Schoolspel", "Van een heuvel af sleeën", "Zwembadspelletjes", "Iemand uit vragen", "'De geest is uit de fles'", "Skateboardtruc", "De loterij winnen", "Liften", "Verjaardagscadeau", "Eerste werkdag", "Slijmen bij de baas", "Huisdier van de Leraar", "In een Zombie Veranderen", "Verrassingsfeestje", "Een Iglo bouwen", "Echte Liefde", "Popcorn opwarmen", "Vuilnisman", "Kunstveiling", "Eerste vlucht met vliegtuig", "Buiten adem raken", "Wild West Duel", "Hittegolf", "Bazige chef", "Roadtrip", "Trefbal", "In een val wandelen", "Op Heterdaad betrapt", "In een spiraal Vastzitten", "De een zijn dood is de ander zijn brood", "Bankoverval", "Eerste Man op Mars", "Een taxi wenken", "Jumping Jacks", "Toerist in een vreemd land", "Golfen", "De pestkop op school", "Een vriend een berichtje sturen", "Wetenschapsproject", "Ouders die hun kinderen in verlegenheid brengen", "Show and Tell", "Luidruchtig vacuüm", "Drive-In Theatre", "Disney Cruise", "Meeuwen die voedsel stelen", "In de rij wachten voor Waterijsjes", "Kabbelende Rivier", "Waterpark", "Zonnebrandcrème opdoen", "Zingen in de douche", "Babyvogel die het nest verlaat", "Oorsmeer", "Uitglijden over een bananenschil", "Een boom planten boom", "Klachten van klanten", "Een berg beklimmen", "Buiten een ballon loslaten", "Familie foto", "Een baard scheren", "Surfen", "Stap op een Crack, Breek je moeder's rug", "Grinch die Kerst steelt", "Worstenbroodjes", "Assepoester die haar schoen verliest", "Je telefoon laten vallen", "Iemand in het zwembad duwen", "Koorddanser", "Tovenaar", "Hond bang voor een onweersbui", "Drie kleine varkens", "Op een scheetkussen zitten", "Een enge film kijken", "In de klas in slaap vallen", "Massage krijgen", "Boos worden op je wekker", "Je mond gebruiken om een ballon op te blazen", "Luidkeels eten", "Struikelen over je schoenveters", "Proberen om je hand in een Pringles Can te steken", "Bananentelefoon", "Staar Wedstrijd", "Buiten een winkel slapen om als eerste iets te kopen", "Een winkel op Black Friday", "Verzet tegen de arrestatie", "Shrink Ray", "Een frisdrank openen nadat je die geschud hebt", "Deeg in de lucht gooien", "Zinkend schip", "Poison Ivy Rash", "Zakdoekje leggen spelen", "Knipperend in de foto", "Chinese Vingerval", "Twee trappen tegelijk opgaan", "Een rotzooi maken van je eten", "De WiFi van je buurman gebruiken", "Redding van de keeper", "Een geest zien", "Citroen uitknijpen", "Kussengevecht", "Iemands Cast tekenen", "Een vlaggenmast beklimmen", "Een bom onschadelijk maken", "Iemand een ketting omdoen", "De korst van een broodje weghalen", "Protesteren", "Kat die een laser achterna jaagt", "Vogel poept op iemand", "Boerende Baby", "Springen in plassen", "Een Confetti-kanon afvuren", "Een T-splitsing in de weg", "Een nieuwe PC bouwen", "Proberen een handstand te doen", "Trollen onder de brug", "De vloer is Lava", "Meditatie", "Praten met je mond vol", "Hot Dog Eetwedstrijd", "Pak spelen met een hond", "Je jas op het rek leggen", "Een gloeilamp vervangen", "Filmdate", "Beltoon van de telefoon tijdens de les", "Estafette", "Wandelen op blote voeten op gras", "Sms'en tijdens een afspraakje", "Cheerleader die valt", "Parallel parkeren", "Schoolbus Evacuatie", "Hindernisbaan", "Boekenworm", "Taco die kapotbreekt als je eet", "Een alligator aanpakken", "Geheime handdruk", "Robin Hood", "Taart in het gezicht krijgen", "Sokken en sandalen", "Durfal Stunt", "Bloemen plukken", "Op een Legoblokje stappen", "Een struik bijknippen", "Marmot die zijn eigen schaduw ziet", "Ramenwasser", "Een auto de ruimte in lanceren", "Dubbel Dipping", "Verjaardag punches", "Rechtstreeks iemand in de ogen niesen", "Schoenenpoetser", "Een hek schilderen", "Je groenten aan de hond geven", "Crowdsurfing", "Je vinger achter de deur laten zitten", "Aap die iets steelt", "Voodoopop", "Vliegenklapper", "Breakdancen", "Ezeltje Prikje", "Op je tong bijten", "Bibberend in de Koude", "Loodgieter die een pijp maakt", "Je sokken uitschudden", "Iemand op de schouders tikken aan de andere kant van aan waar jij staat", "Walvissen spotten", "Kussen Fort", "Het raam van je buurman met een bal kapot schieten", "Koffie morsen op jezelf", "Iemands geest lezen", "Je rug krabben", "Kat die aan het meubilair krabt", "Schoollunch", "Autodealer", "Kaarten in je mouw", "Scheten laten met je oksels", "Belletje lellen", "Dansen in de regen", "Vastzitten in Drijfzand", "Brandoefening", "Rotsen beklimmen", "Hert in koplampen", "Spieken bij een klasgenootje tijden een test", "De deur voor een verkoper dichtdoen", "Pruik die eraf valt", "Trap naar de hemel", "Aardbeving", "Stierenrijden", "Vee verzamelen", "Spugen in iemands gezicht terwijl je praat", "Tekenen op het gezicht van iemand die slaapt", "Per ongeluk je broek uitscheuren", "Kind dat zich voordoet als een volwassene", "Iemand negeren", "Statische elektriciteit", "Steen overslaan", "Katten landen altijd op hun voeten", "Zwaaien naar Iemand die niet naar je zwaaide", "Volume te hoog", "Freeze Tag", "Proberen een kind te laten glimlachen in een foto", "Poppenshow", "Waterbed", "Veiligheidshelmen redden levens", "Naar complimentjes hengelen", "Bovenbuurman die stampt", "Een drankautomaat door elkaar rammelen", "Een trui breien", "Slaapverhaaltjes", "Teleportatieapparaat", "Sneller gaan dan de snelheid van het licht", "Op dun ijs wandelen", "Gebarentaal", "Iemands gezicht in een taart duwen", "'Ik heb je neus'", "Verhuisdozen" };
    ...
    void Awake() {
        ...
        EnabledThemesList = new List<int>();
        EnabledThemesList.Add(0);
        EnabledThemesList.Add(1);
        //EnabledThemesList.Add(1);
        randomListTheme = new List<List<string>>();
        randomListTheme.Add(new List<string>());
        randomListTheme.Add(new List<string>());
        //randomListTheme[0] = new List<string>();
        //randomListTheme[1] = new List<string>();
    }
    void Start()
    {
        Arrow.enabled = false;
    ...
    {
        //foreach (string g in randomListJaggedArray2[o][gameLanguage])
        //{
        //    randomList.Remove(g);
        //}
        randomListTheme = new List<List<string>>();
        randomListTheme.Add(new List<string>());
        randomListTheme.Add(new List<string>());
        randomList = new List<string>(); //reset the random word list, so you don't get a word in the wrong language
    ...
    void onConnection(int device_id)
    {
        ...
        if (AirConsole.instance.GetMasterControllerDeviceId() == device_id)
        {
            ...
            //when new master controller is set, re-enable all themes
            EnabledThemesList = new List<int>();
            EnableTheme(0);
            EnableTheme(1);
            //EnabledThemesList.Add(1);
    ...
    void EnableTheme(int num)
    {
        if (!EnabledThemesList.Contains(num))
        {
            EnabledThemesList.Add(num);
            Debug.Log("ENABLING THEME: " + num);
            audio2.clip = clips[1];
            audio2.Play();
            if (randomListTheme[num].Count == 0)
            {
                foreach (string g in randomListJaggedArray2[num][gameLanguage])
                {
                    randomList.Add(g);
                    randomListTheme[num].Add(g);
                }
            }
            else
            {
                foreach (string b in randomListTheme[num])
                {
                    randomList.Add(b);
                }
            }
    ...
    void OnMessage(int deviceId, JToken imgURL)
    {
        ...
        else if (finalURL.Contains("GameHandler.mode:") && currentMode == "Menu")
        {
            ...
            if (finalURL == "RandomPrompt")
            {
                if (gameMode != "RandomPrompt")
                {
                    audio2.clip = clips[1];
                    audio2.Play();
                    //if (EnabledThemesList.Contains(1))
                    //{
                    //    EnabledThemesList.Remove(1);
                    //    foreach (string b in randomListTheme[1])
                    //    {
                    //        randomList.Remove(b);
                    //    }
                    //}
        ...
        else if (finalURL.Contains("GameHandler.enabletheme:") && currentMode == "Menu")
        {

            finalURL = finalURL.Replace("GameHandler.enabletheme:", "");
            EnableTheme(Int32.Parse(finalURL));
            /*if (!EnabledThemesList.Contains(Int32.Parse(finalURL)))
            {
                EnabledThemesList.Add(Int32.Parse(finalURL));
                Debug.Log("ENABLING THEME: " + Int32.Parse(finalURL));
                audio2.clip = clips[1];
                audio2.Play();
                if (randomListTheme[Int32.Parse(finalURL)].Count == 0)
                {
                    foreach (string g in randomListJaggedArray2[Int32.Parse(finalURL)][gameLanguage])
                    {
                        randomList.Add(g);
                        randomListTheme[Int32.Parse(finalURL)].Add(g);
                    }
                }
                else
                {
                    foreach (string b in randomListTheme[Int32.Parse(finalURL)])
                    {
                        randomList.Add(b);
                    }
                }
        ...
        else if (finalURL.Contains("GameHandler.disabletheme:") && currentMode == "Menu")
        {

            finalURL = finalURL.Replace("GameHandler.disabletheme:", "");
            if (EnabledThemesList.Contains(Int32.Parse(finalURL)))
            {
                EnabledThemesList.Remove(Int32.Parse(finalURL));
                Debug.Log("DISABLING THEME: " + Int32.Parse(finalURL));
                audio2.clip = clips[1];
                audio2.Play();
                foreach (string b in randomListTheme[Int32.Parse(finalURL)])
                {
    ...
    public IEnumerator StartTheGame()
    {
        if (isGameStarted == false)
        {
            ...
            {
                randomList = new List<string>();
                //randomListMisc = new List<string>();
                //randomListHalloween = new List<string>();
                //randomListTheme = new List<List<string>>();
                foreach (int b in EnabledThemesList)
                {
                    Debug.Log("DEBUGG " + b);
                    randomListTheme[b] = new List<string>();
                    //randomListTheme[b] = randomListJaggedArray2[b][gameLanguage];
                }
                //randomListMisc = randomListJaggedArray2[0][gameLanguage];
                /*foreach (string i in randomListJaggedArray2[0][gameLanguage])
                {
                    //Debug.Log("ADDING " + i);
                    randomListTheme[0].Add(i);
                    //randomListMisc.Add(i);
                }
                foreach (string i in randomListJaggedArray2[1][gameLanguage])
                {
                    randomListTheme[1].Add(i);
                    //Debug.Log("ADDING " + i);
                    randomListHalloween.Add(i);
                }*/

                foreach (int g in EnabledThemesList)
                {
                    foreach (string i in randomListJaggedArray2[g][gameLanguage])
                    {
                        //Debug.Log("ADDING " + i);
                        randomList.Add(i);
                        randomListTheme[g].Add(i);
                    }
                }
            }
            //randomList = new List<string>();
            ...
            foreach (int i in AirConsole.instance.GetActivePlayerDeviceIds)
            {
                ...
                if (gameMode == "RandomPrompt")
                {
                    if (randomList.Count == 0)
                    {
                        ...
                        foreach (int g in EnabledThemesList)
                        {
                            foreach (string b in randomListJaggedArray2[g][gameLanguage])
                            {
                                //Debug.Log("ADDING " + i);
                                randomList.Add(b);
                                randomListTheme[g].Add(b);
                            }
                        }
                    }
                    ...
                    randomList.Remove(randomList[randomint]);
                    foreach (int g in EnabledThemesList)
                    {
                        if (randomListJaggedArray2[g][gameLanguage].Contains(therandom))
                        {
                            randomListTheme[g].Remove(therandom);
                        }
                    }
    ...
    IEnumerator startIntroduction()
    {
        ...
        IntroductionImage3.sprite = Resources.Load<Sprite>("Sprites/Introduction/DrawingPhaseTVBackground");
        ...
        IntroductionImage3.sprite = Resources.Load<Sprite>("Sprites/Introduction/GuessingPhaseTVBackground");
        IntroductionImage2.sprite = Resources.Load<Sprite>("Sprites/Introduction/Language" + gameLanguage + "/3"); //guessing "angry pirate" image
        ...
        Hand2.GetComponent<Animator>().SetBool("HandActive", true);
        IntroductionImage3.sprite = Resources.Load<Sprite>("Sprites/Introduction/GuessingPhaseTVBackground");
        IntroductionImage2.sprite = Resources.Load<Sprite>("Sprites/Introduction/Language" + gameLanguage + "/6");
        audio2.clip = clips[7];
        if (gameLanguage == 0)
        {
            audio2.Play();
        ...
        yield return new WaitForSeconds(2);
        ZoomPanel.GetComponent<Animator>().SetBool("PlayZoom", true);
        yield return new WaitForSeconds(2);
        IntroductionImage3.sprite = Resources.Load<Sprite>("Sprites/Introduction/Language" + gameLanguage + "/IntroductionFinal1");
        yield return new WaitForSeconds(2);
        IntroductionImage3.sprite = Resources.Load<Sprite>("Sprites/Introduction/Language" + gameLanguage + "/IntroductionFinal2");
        yield return new WaitForSeconds(2);
        IntroductionImage3.sprite = Resources.Load<Sprite>("Sprites/Introduction/Language" + gameLanguage + "/IntroductionFinal3");
        yield return new WaitForSeconds(2);
        IntroductionImage3.sprite = Resources.Load<Sprite>("Sprites/Introduction/Language" + gameLanguage + "/IntroductionFinal4");
        ...
        yield return new WaitForSeconds(5);
        ZoomPanel.GetComponent<Animator>().SetBool("PlayZoom", false);
    }
    ...
    IEnumerator TransitionAnimate(float wait)
    {
        int transnum = UnityEngine.Random.Range(1, 4);
        TransitionObject.GetComponent<Animator>().SetTrigger("Transition"+ transnum + "Activate");
        yield return new WaitForSeconds(wait);
        TransitionObject.GetComponent<Animator>().SetTrigger("Transition" + transnum + "Exit");
    }
    ...
    IEnumerator fadeCanvas(string fadedout, string fadein, float waitBetween)
    {
        ...
        else
        {
            ...
            if (fadein == "PostGame"|| fadein == "Draw" || fadein == "Guess" || fadein == "InitialPhrase")
            {
                ...
                StartCoroutine(TransitionAnimate(waitBetween + 1.5f));
            ...
            {
            StartCoroutine(TransitionAnimate(3f));
            yield return new WaitForSeconds(2.5f);
            }
            //yield return new WaitForSeconds(0.5f);
        }
        ...
        else if (fadein == "InitialPhrase")
        {
            ...
            initialPhraseImage.fillAmount = 1;
        }
        else if (fadein == "PostGame")
        {
