    ...
    IEnumerator fadeCanvas(string fadedout, string fadein, float waitBetween)
    {
        ...
        else
        {
            ...
            if (fadein == "PostGame"|| fadein == "Draw" || fadein == "Guess" || fadein == "InitialPhrase")
            {
                ...
                //TransitionObject.GetComponent<Animator>().SetTrigger("Transition1Activate");
                ...
                PhaseIntro.SetActive(false);
                //TransitionObject.GetComponent<Animator>().SetTrigger("Transition1Exit");
            }
            else
            {
                StartCoroutine(TransitionAnimate(2f));
